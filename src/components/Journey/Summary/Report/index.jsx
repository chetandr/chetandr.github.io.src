...
const Report = () => {
	...
	return (
		<Box>
			<Card>
				<CardHeader title='Assessment Summary' titleTypographyProps={{ align: 'center' }} />
				<CardContent>
					<Grid container spacing={2}>
						<Grid item xs={6}>
							<Box p={2}>
								<Typography variant='body2'>Make</Typography>
								<Typography variant='h6'>DKVGR56</Typography>
							</Box>
						</Grid>
						<Grid item xs={6}>
							<Box p={2}>
					...
					<Grid container spacing={2}>
						<Grid item xs={6}>
							<Box p={2}>
								...
								<Typography variant='h6'>9SBR6X40003883738</Typography>
							</Box>
						</Grid>
						<Grid item xs={6}>
							<Box p={2}>
								<Typography variant='body2'>Policy Number</Typography>
								<Typography variant='h6'>Vin 256</Typography>
							</Box>
						</Grid>
					</Grid>
					<Grid container spacing={2}>
						...
						<Grid item xs={6}>
							<Box p={2}>
								...
								<Typography variant='h6'>21 June 2021</Typography>
							</Box>
						</Grid>
					</Grid>
					<Grid container spacing={2}>
						<Grid item xs={6}>
							<Box p={2}>
								<Typography variant='body2'>Preferred Repair Location</Typography>
								<Typography variant='h6'>Sandton</Typography>
							</Box>
						</Grid>
					</Grid>
				</CardContent>
			...
			<Box p={1} m={2} textAlign='right'>
				<RoundedButton label='Submit' fullWidth={false} onClick={() => setAckOpen(true)} />
			</Box>
			<Dialog open={ackOpen} size='md'>
				...
				<DialogActions style={{justifyContent: "center"}}>
					<RoundedButton label='Ok' onClick={() => {}} fullWidth={false}></RoundedButton>
				</DialogActions>
			</Dialog>
		</Box>
	);
